...
## Planning
* Trello – Used like Scrum Sprint Style Backlog (Similar to Design Thinking) 

## Communications
* WhatsApp – Used for Main Communication

* Slack – Used for Voice Chat & App Integration Notifications like GitHub Commits

## Hosting
* Spaceship EasyWP-Starter 
    * Own Domain (baizonn-learning-center.shop/)
    * Free SSL (HTTPS)
